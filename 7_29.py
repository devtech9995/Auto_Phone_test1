...
class Ui_MainWindow(QMainWindow):
    ...
    def judgement(self):
        ...
        if current_day == "Monday":
            ...
            condition = current_minute < 490 or current_minute > 1250
        else:
            condition = current_minute < 490 and current_minute > 210
        return(condition)
            ...
            for row in range(2):
                for col in range(2):
                    ...
                    if self.flag_active: 
                            ...
                            x = col * self.colStep 
                            y = row * self.rowStep
                            self.point_error_text = (x+270, y+192)                        
                            error_img = self.get_snapshot(self.point_error_text, 347, 36)
...
if __name__ == "__main__":
    ...
    hwnd = ctypes.windll.user32.FindWindowW(None, "NTT西日本 フレッツ光判定システム")
